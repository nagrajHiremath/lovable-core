...
export const ChatEventRenderer = ({ event, isLoading }: { event: ChatEvent, isLoading?: boolean }) => {
  switch (event.type) {
    ...
    case ChatEventType.MESSAGE:
      return (
        <div className="prose prose-invert prose-sm max-w-none text-foreground leading-relaxed mb-4">
      ...
      <div className="flex items-center justify-between w-full">
        ...
        {showButton && (
          <button 
            ...
            className="text-muted-foreground hover:text-foreground text-[12px] font-medium bg-muted/40 px-2 py-0.5 rounded border border-border transition-colors ml-4"
          >
